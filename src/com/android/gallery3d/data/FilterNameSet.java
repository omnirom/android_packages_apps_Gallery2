...
// FilterStringSet filters a base MediaSet according to a matching name.
public class FilterNameSet extends MediaSet implements ContentListener {
    @SuppressWarnings("unused")
    private static final String TAG = "FilterNameSet";

    private final DataManager mDataManager;
    private final MediaSet mBaseSet;
    private final String mMatchPattern;
    private final ArrayList<Path> mPaths = new ArrayList<Path>();
    private final ArrayList<MediaSet> mAlbums = new ArrayList<MediaSet>();

    public FilterNameSet(Path path, DataManager dataManager, MediaSet baseSet,
            String pattern) {
    ...
    private void updateData() {
        // Albums
        mAlbums.clear();
        String basePath = "/filter/name/" + mMatchPattern;
